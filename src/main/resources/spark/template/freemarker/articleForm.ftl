<div class="starter-template">
    ...
    <form class="form-horizontal" role="form" id='article-create-form' method='POST' <#if article??>action="/article/update/:id"<#else>action="/article/create"</#if>>
        ...
        <div class="form-group">
            <label control-label" for="title">Title: </label>
            <div>
        ...
        <div class="form-group">
            <label control-label" for="summary">Summary: </label>
            <div >
    ...
    <textarea class="form-control" name='article-content' id="content" rows='4' cols='50' form='article-create-form' 
    ...
    <input type='submit' 
    	<#if article??>value='Update'
    	<#else>value='Publish'
    	</#if> 
    	class="btn btn-primary" form='article-create-form' />
